...
entirely — not usable at all. So in principle, CUDA 12.2–12.7 paired with
VS2019 (not VS2022) might also work cleanly and stably on Pascal — that
specific combination hasn't been tested here. 12.1 is documented because
it's what was actually verified end-to-end on this hardware, not because
it's the only stable option. If you try a newer CUDA/VS2019 pairing and it
works, that's a real data point worth reporting back via an Issue.
